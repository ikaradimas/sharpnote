...
export const DOCS_SECTIONS = [
  {
    ...
    content: [
      ...
      { type: 'ul', items: [
        ...
        'Panels.Open/Close/Toggle(PanelId.*) → control workspace panel visibility from code',
  ...
  },
  {
    ...
    content: [
      { type: 'p', text: 'The Panels global lets you open, close, or toggle any workspace panel from within a code cell. Use it in setup notebooks to put the UI in exactly the right state before you start working.' },
      ...
      { type: 'code', text: '// Open the graph and close everything else\nPanels.Open(PanelId.Graph);\nPanels.Close(PanelId.Log);\nPanels.Close(PanelId.Config);\n\n// Toggle the variable inspector\nPanels.Toggle(PanelId.Variables);' },
    ],
  },
  {
