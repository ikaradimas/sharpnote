...
export const DOCS_SECTIONS = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'p', text: 'Push data points to the graph mid-execution using Display.Plot(name, value, mode, axis). The x-axis shows timestamps automatically. Each point is plotted against real time.' },
      { type: 'ul', items: [
