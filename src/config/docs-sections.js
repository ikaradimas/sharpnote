...
export const DOCS_SECTIONS = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'p', text: 'A decision cell is a code cell that evaluates a boolean expression. Based on the result (true or false), execution branches to different downstream cells. Add a decision cell via the + bar or the toolbar dropdown.' },
      { type: 'ul', items: [
        'The cell body must evaluate to a bool (e.g. Config["env"] == "prod")',
        'True path — the cells wired to the "true" output execute when the expression is truthy',
        'False path — the cells wired to the "false" output execute when the expression is falsy',
        'Decision cells appear as diamond-shaped nodes in the dependency graph',
      ]},
