  ...
  },
  {
    ...
    content: [
      ...
      { type: 'ul', items: [
        ...
        'axis: "y" (default, left) or "y2" (right) — assigns the series to a y-axis',
        'type: "line", "area", or "bar" — sets the chart type for this series; omit to use the panel default',
      ]},
