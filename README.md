...
- **Inline Variable Peek** — hover over any variable name in the code editor to see its type and current value in a tooltip; powered by the kernel's live variable state
