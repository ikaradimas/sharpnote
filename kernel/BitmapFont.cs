...
/// Each character is 7 bytes (one per row), MSB-first (bit 4 = leftmost pixel).
/// </summary>
internal static class BitmapFont
{
    internal const int CharWidth  = 5;
    internal const int CharHeight = 7;
    internal const int FirstChar  = 32;
    internal const int LastChar   = 126;

    // 95 characters × 7 rows = 665 bytes
